...
Neste nivel o sistema ainda se parece com um assistente convencional, mas ja usa percepcao melhor, task anchor e um monitor basico de confianca. O foco e reduzir erros banais e melhorar obediencia estrutural.

## Missao operacional

Neste nivel o sistema ainda se parece com um assistente convencional, mas ja usa percepcao melhor, task anchor e um monitor basico de confianca. O foco e reduzir erros banais e melhorar obediencia estrutural. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
O nivel 1 funciona como base porque instala controle minimo sem impor custo excessivo.
