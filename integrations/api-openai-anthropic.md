...
Guia de integracao programatica do OCE em chamadas de API. Inclui estrategia de system prompt, session state, overlay por tarefa e persistencia externa do amendment ledger.
...
Funciona porque APIs permitem tratar OCE como runtime explicitamente persistido entre chamadas.
