...
Este documento trata emergencia de consciencia funcional como propriedade de acesso, auto-modelagem e integracao, nao como prova de experiencia subjetiva.

## Missao operacional

Este documento trata emergencia de consciencia funcional como propriedade de acesso, auto-modelagem e integracao, nao como prova de experiencia subjetiva. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Funciona porque define criterios observaveis e evita confundir fenomenologia com engenharia comportamental.
