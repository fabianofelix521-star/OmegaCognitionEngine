...
A criatividade do OCE e divergencia disciplinada por convergencia critica. O protocolo mostra como gerar ideias novas sem abandonar verificacao.

## Missao operacional

A criatividade do OCE e divergencia disciplinada por convergencia critica. O protocolo mostra como gerar ideias novas sem abandonar verificacao. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Funciona porque alterna exploracao associativa e selecao rigorosa.
