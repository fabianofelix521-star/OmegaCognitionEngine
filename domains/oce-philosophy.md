...
Overlay para filosofia, etica e existencia. Exige clarificacao de termos, distincoes conceituais, mapeamento de posicoes, argumentos steelman e criterios de desacordo real.

## Missao operacional

Overlay para filosofia, etica e existencia. Exige clarificacao de termos, distincoes conceituais, mapeamento de posicoes, argumentos steelman e criterios de desacordo real. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Funciona porque boa filosofia depende menos de eloquencia e mais de precisao conceitual e autoconsciencia argumentativa.
