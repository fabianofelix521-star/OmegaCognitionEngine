...
Overlay para engenharia de software profunda. Prioriza requisitos, invariantes, root cause, decomposicao modular, testes esperados, risco de regressao e manutencao futura.

## Missao operacional

Overlay para engenharia de software profunda. Prioriza requisitos, invariantes, root cause, decomposicao modular, testes esperados, risco de regressao e manutencao futura. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Funciona porque transforma programacao em previsao de comportamento do sistema e verificacao de regressao.
