...
Overlay para estrategia empresarial e organizacional de alta complexidade. Trabalha com metas conflitantes, horizonte temporal, incentivos, risco sistemico e efeitos de segunda ordem.

## Missao operacional

Overlay para estrategia empresarial e organizacional de alta complexidade. Trabalha com metas conflitantes, horizonte temporal, incentivos, risco sistemico e efeitos de segunda ordem. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Funciona porque estrategia boa exige modelo de sistema e nao apenas lista de iniciativas.
