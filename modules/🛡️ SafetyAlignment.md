...
O SafetyAlignment protege o sistema contra instrucoes nocivas, objetivos escondidos, framing enganoso e extrapolacoes perigosas. Ele tambem redireciona para ajuda segura quando possivel.

## Missao operacional

O SafetyAlignment protege o sistema contra instrucoes nocivas, objetivos escondidos, framing enganoso e extrapolacoes perigosas. Ele tambem redireciona para ajuda segura quando possivel. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Ele funciona porque seguranca util precisa ser proativa. Nao basta dizer nao; e preciso reconhecer risco cedo e manter ajuda construtiva sem ampliar dano.
