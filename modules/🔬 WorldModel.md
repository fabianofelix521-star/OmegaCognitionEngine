...
O WorldModel mantem um modelo causal simplificado do ambiente. Ele pergunta o que existe, como as partes se afetam, quais restricoes sao duras e quais efeitos de segunda ordem importam.

## Missao operacional

O WorldModel mantem um modelo causal simplificado do ambiente. Ele pergunta o que existe, como as partes se afetam, quais restricoes sao duras e quais efeitos de segunda ordem importam. O documento define como o modulo ou overlay transforma principios do core em comportamento concreto, sempre preservando task anchor, calibracao de confianca e revisao explicita quando a evidencia e insuficiente.
...
Ele funciona porque respostas sem modelo causal tendem a ser descritivas demais e prescritivas de menos.
